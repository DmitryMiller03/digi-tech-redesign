...
export function AudienceDropdown({ light = false }: { light?: boolean }) {
  ...
  return (
    ...
    >
      ...
      {open && (
        <div className="absolute left-1/2 top-full z-50 mt-3 w-72 max-w-[calc(100vw-2rem)] -translate-x-1/2 rounded-xl border border-line bg-surface-elevated p-2 shadow-lg">
